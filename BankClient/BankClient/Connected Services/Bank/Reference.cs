...
namespace Bank
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://thomas-bayer.com/blz/", ConfigurationName="Bank.BLZServicePortType")]
    public interface BLZServicePortType
    {
        ...
        Bank.getBankResponse getBank(Bank.getBankRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="http://thomas-bayer.com/blz/BLZService/getBankResponse")]
        System.Threading.Tasks.Task<Bank.getBankResponse> getBankAsync(Bank.getBankRequest request);
    }
    ...
    public partial class getBankResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://thomas-bayer.com/blz/", Order=0)]
        public Bank.detailsType details;
        
        public getBankResponse()
        {
        }
        
        public getBankResponse(Bank.detailsType details)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface BLZServicePortTypeChannel : Bank.BLZServicePortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class BLZServicePortTypeClient : System.ServiceModel.ClientBase<Bank.BLZServicePortType>, Bank.BLZServicePortType
    {
        ...
        public Bank.getBankResponse getBank(Bank.getBankRequest request)
        {
            return base.Channel.getBank(request);
        }
        
        public System.Threading.Tasks.Task<Bank.getBankResponse> getBankAsync(Bank.getBankRequest request)
        {
